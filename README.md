[![Release](https://img.shields.io/badge/release-v2.0.3-blue.svg)](https://github.com/scaleflex/js-cloudimage-responsive/releases)
...
```javascript
<script src="https://cdn.scaleflex.it/plugins/js-cloudimage-responsive/2.0.3/js-cloudimage-responsive.min.js"></script>
```

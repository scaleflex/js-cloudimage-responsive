[![Release](https://img.shields.io/badge/release-v4.2.0-blue.svg)](https://github.com/scaleflex/js-cloudimage-responsive/releases)
...
```javascript
<script src="https://cdn.scaleflex.it/plugins/js-cloudimage-responsive/4.2.0/blur-hash/js-cloudimage-responsive.min.js"></script>
```

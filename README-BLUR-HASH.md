[![Release](https://img.shields.io/badge/release-v4.8.4-blue.svg)](https://github.com/scaleflex/js-cloudimage-responsive/releases)
...
<p align="center">
	<strong>
		...
		•
		<a href="https://cdn.scaleflex.it/plugins/js-cloudimage-responsive/demo/blur-hash/index.html?v=28.04.2020_2" target="_blank">Demo</a>
		•
...
```javascript
<script src="https://cdn.scaleflex.it/plugins/js-cloudimage-responsive/4.8.4/blur-hash/js-cloudimage-responsive.min.js"></script>
```

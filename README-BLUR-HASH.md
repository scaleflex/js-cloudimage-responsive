[![Release](https://img.shields.io/badge/release-v3.4.2-blue.svg)](https://github.com/scaleflex/js-cloudimage-responsive/releases)
...
```javascript
<script src="https://cdn.scaleflex.it/plugins/js-cloudimage-responsive/3.4.2/blur-hash/js-cloudimage-responsive.min.js"></script>
```

...
// you Have to repport here
    this.config.vectors = [{
        "CLASSNAME": "","VECTOR": vector_default,"OPERATION": "width","PARAMETER": "n"
   /* },{
	"CLASSNAME": "thumbsnail", "VECTOR": vector_thumbsnail, "OPERATION": "crop", "PARAMETER" : "n" */
...
jScaler.addSources = function(img) {
    ...
    config.VECTOR.forEach(function(vector, index, ar) {
        switch (config.OPERATION) {
            case "width":
                this.before(img, '<source media="(max-width:' + vector.screenWidth + 'px)"' + ' ' +
                            'srcset="https://' + this.config.TOKEN + '.cloudimg.io/' + config.OPERATION + '/' + vector.imgWidth + '/'+ config.PARAMETER +'/' + this.attr(img, 'data-src') + ' 1x, ' +
                                    'https://' + this.config.TOKEN + '.cloudimg.io/' + config.OPERATION + '/' + Math.trunc(1.5 * vector.imgWidth) + '/'+ config.PARAMETER + '/' + this.attr(img, 'data-src') + ' 1.5x, ' +
                                    'https://' + this.config.TOKEN + '.cloudimg.io/' + config.OPERATION + '/' + 2 * vector.imgWidth + '/'+ config.PARAMETER + '/' + this.attr(img, 'data-src') + ' 2x, ' +
                                    'https://' + this.config.TOKEN + '.cloudimg.io/' + config.OPERATION + '/' + 3 * vector.imgWidth + '/'+ config.PARAMETER + '/' + this.attr(img, 'data-src') + ' 3x">');

            break;
            case "height":
                this.before(img, '<source media="(max-height:' + vector.screenHeight + 'px)"' + ' ' +
                             		'srcset="https://' + this.config.TOKEN + '.cloudimg.io/' + config.OPERATION + '/' + vector.imgHeight + '/'+ config.PARAMETER +'/' + this.attr(img, 'data-src') + ' 1x, ' +
                             		 		    'https://' + this.config.TOKEN + '.cloudimg.io/' + config.OPERATION + '/' + Math.trunc(1.5 * vector.imgHeight) + '/'+ config.PARAMETER + '/' + this.attr(img, 'data-src') + ' 1.5x, ' +
                             		 		    'https://' + this.config.TOKEN + '.cloudimg.io/' + config.OPERATION + '/' + 2 * vector.imgHeight + '/'+ config.PARAMETER + '/' + this.attr(img, 'data-src') + ' 2x, ' +
                             		 		    'https://' + this.config.TOKEN + '.cloudimg.io/' + config.OPERATION + '/' + 3 * vector.imgHeight + '/'+ config.PARAMETER + '/' + this.attr(img, 'data-src') + ' 3x">');
            ...
            case "bound":
                this.before(img, '<source media="(max-width:' + vector.screenWidth + 'px)"' + ' ' +
                               'srcset="https://' + this.config.TOKEN + '.cloudimg.io/' + config.OPERATION + '/' + vector.imgWidth + 'x' + vector.imgHeight + '/'+ config.PARAMETER + '/' + this.attr(img, 'data-src') + ' 1x, ' +
                                      'https://' + this.config.TOKEN + '.cloudimg.io/' + config.OPERATION + '/' + Math.trunc(1.5 * vector.imgWidth) + 'x' + Math.trunc(1.5 *vector.imgHeight) + '/'+ config.PARAMETER + '/' + this.attr(img, 'data-src') + ' 1.5x, ' +
                                      'https://' + this.config.TOKEN + '.cloudimg.io/' + config.OPERATION + '/' + 2 * vector.imgWidth + 'x' + 2 *vector.imgHeight + '/'+ config.PARAMETER + '/' + this.attr(img, 'data-src') + ' 2x, ' +
                                      'https://' + this.config.TOKEN + '.cloudimg.io/' + config.OPERATION + '/' + 3 * vector.imgWidth + 'x' + 3 *vector.imgHeight + '/'+ config.PARAMETER + '/' + this.attr(img, 'data-src') + ' 3x">');
            ...
            default:
                this.before(img, '<source media="(max-width:' + vector.screenWidth + 'px)"' + ' ' +
                                'srcset="https://' + this.config.TOKEN + '.cloudimg.io/s/resize/' + vector.imgWidth + '/' + this.attr(img, 'data-src') + ' 1x, ' +
                                        'https://' + this.config.TOKEN + '.cloudimg.io/s/resize/' + Math.trunc(1.5 * vector.imgWidth) + '/' + this.attr(img, 'data-src') + ' 1.5x, ' +
                                        'https://' + this.config.TOKEN + '.cloudimg.io/s/resize/' + 2 * vector.imgWidth + '/' + this.attr(img, 'data-src') + ' 2x, ' +
                                        'https://' + this.config.TOKEN + '.cloudimg.io/s/resize/' + 3 * vector.imgWidth + '/' + this.attr(img, 'data-src') + ' 3x">');

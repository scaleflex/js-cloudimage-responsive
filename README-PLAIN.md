...
<p align="center">
	<strong>
		...
		•
		<a href="https://scaleflex.airstore.io/plugins/js-cloudimage-responsive/demo/plain/index.html?v=15.04.2020_2" target="_blank">Demo</a>
		•
...
[Demo page](https://scaleflex.airstore.io/plugins/js-cloudimage-responsive/demo/plain/index.html?v=15.04.2020_2).
...
```javascript
<script src="https://cdn.scaleflex.it/plugins/js-cloudimage-responsive/4.2.1/plain/js-cloudimage-responsive.min.js"></script>
```

You may also use major version number instead of fixed version to have the latest version available.

```javascript
<script src="https://cdn.scaleflex.it/plugins/js-cloudimage-responsive/4/plain/js-cloudimage-responsive.min.js"></script>
```

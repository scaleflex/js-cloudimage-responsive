[![Release](https://img.shields.io/badge/release-v3.5.0-blue.svg)](https://github.com/scaleflex/js-cloudimage-responsive/releases)
...
```javascript
<script src="https://cdn.scaleflex.it/plugins/js-cloudimage-responsive/3.5.0/plain/js-cloudimage-responsive.min.js"></script>
```
